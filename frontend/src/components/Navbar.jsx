...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-200 p-4 stciky top-0">
      <div className="flex container mx-auto justify-between items-center">
        ...
        <div className="flex gap-2 items-center">
          ...
          <p className="hidden sm:block text-2xl">
            Code <span className="font-bold text-2xl">Canvas</span>
          </p>
        </div>

        {/* center content */}
        <ul className="hidden sm:flex gap-20 text-xl font-normal justify-center items-center text-gray-700">
          <Link
            to="/"
